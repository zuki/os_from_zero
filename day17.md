...
![FATボリュームマップ](http://elm-chan.org/docs/rc/fat_map.png)

<center> FATボリュームマップ (http://elm-chan.org/docs/rc/fat_map.png)</center>

```
0x00000000 BPB      0x200
0x00000200 FSInfo   0x200
*                   (32 - 2) * 0x200
0x00004000 FAT      0x634 * 0x200
0x000ca800 FAT2     0x634 * 0x200
0x00191000 Data     0x20 * xxx
```

## kernel.elfの場合

```
00191080: 4b45 524e 454c 2020 454c 4620 1895 cf88  KERNEL  ELF ....
00191090: 9152 9152 0000 cf88 9152 1300 a8d0 2300  .R.R.....R....#.
```

- ファイル長:   0x0023d0a8 (2347176) / 0x400(1024) = 0x8f4(2292) クラスタ
- 開始クラスタ: 0x00000013 ( 0x4000 + 4 * 0x13 = 0x404c: 1400 0000 )
- 終了クラスタ: 0x404c + 0x8f4 * 4 = 0x641c: ffff ff0f)
- ファイルの先頭: 0x191000 + (0x13 - 2) * 0x400 = 0x195400
  ```
  00195400: 7f45 4c46 0201 0100 0000 0000 0000 0000  .ELF............
  00195410: 0200 3e00 0100 0000 a0eb 1000 0000 0000  ..>.............
  ```
